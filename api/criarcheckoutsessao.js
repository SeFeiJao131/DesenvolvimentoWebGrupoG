...
export default async function handler(req, res) {
  ...
  try {
    ...
    const session = await stripe.checkout.sessions.create({
      ...
      success_url:          `${base}/html/checkoutretorno.html?session_id={CHECKOUT_SESSION_ID}&produto=${produtoId}`,
      cancel_url:           `${base}/html/checkout.html?id=${produtoId}&cancelado=1`,
